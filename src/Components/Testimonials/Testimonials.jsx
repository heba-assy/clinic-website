...
import testimonialImg from "../../assets/imgs/testimonials.jpg";
import {
  faChevronLeft,
  faChevronRight,
  faStar as solidStar,
      ...
      <section id="testimonials" className="bg-[#F9FBEF] py-10 md:py-24">
        <div className="container">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            ...
            {/* Image */}
            <div className="hidden md:block relative rounded-4xl overflow-hidden max-w-[700px] max-h-[750px]">
              <img src={testimonialImg} className="w-full object-cover" alt="Before and after microneedling results showing reduced acne and clearer skin"/>
